...
public class SendEmailUtil {
    ...
    public  void sendEmail(String authCode,String reciver) throws Exception {
        ...
        //邮件发送者
        msg.setFrom(new InternetAddress("1455469266@qq.com"));

        //发送邮件
        Transport transport = session.getTransport();
        //在邮箱的设置中开启POP3/SMTP服务得到授权码
        transport.connect("smtp.qq.com", "1455469266@qq.com", "okpojwslplpbjdef");

        transport.sendMessage(msg, new Address[] { new InternetAddress(reciver) });
        transport.close();
    }
}